...
def letter_grades(highest: int):
    ...
    for ctr in range(41, highest, increment):
        grades.append(ctr)
...
def student_ranking(student_scores, student_names):
    ...
    """
    ranking = {}
    for ctr, score in enumerate(student_scores):
        ranking[score] = student_names[ctr]

    ranking_order = []
    for ctr, score in enumerate(ranking):
        ranking_order.append(f"{ctr+1}. {ranking[score]}: {score}")
